...
import java.util.*;
public class FriendsEnroll
{
 public static void main(String[]args)
 {
   Scanner sc = new Scanner(System.in);
   System.out.println("Enter a The T case:");
   int Test=sc.nextInt();
   switch(Test)
   {
     case 1:
	 System.out.println("the friend group,: the capacity of the course and: the number of students:");
	 int n=sc.nextInt();
	 int m=sc.nextInt();
	 int k=sc.nextInt();
	  ...
	  if(n+k<=m)
       {
		...
		break;
    default :
     System.out.println("Invaild output plz! recorrect test TT case ");	
   }
 }
